...
Explanation:
	...
	Both of these values will be on the stack, instead on the heap because objects will point to the armor object, not to any of its state (refer to the Meter class for an example).
*/
